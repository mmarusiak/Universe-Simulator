...
* listHolder - list of every gravity object script, updated via [controller](https://github.com/mmarusiak/Universe-Simulator/blob/main/Code%20Documentation/02.%20GravityObjectsController.cs.md#void-addgravityobject);
