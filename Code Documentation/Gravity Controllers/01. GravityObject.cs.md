...
* Velocity - velocity at the moment of game pause;
...
## void Start
At start we set up scale of our game object with radius, velocity (to initial velocity) and start position of planet. Also we set up controller and rigidbody. Than we call AddGravityObject on controller. Then we setup mass and velocity to our rigidbody by values provided by user. At the end we disabling this script, because at start game is paused.
